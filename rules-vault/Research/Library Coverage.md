...
updated: 2026-08-21
---
# 📊 Library Coverage — what's been read, what's pending
...
| Status | Means |
|---|---|
| 🟢 **Captured** | Read through the pipeline. Note + verbatim capture in `research/sources/`, evidence-tagged, page-cited |
| 🟡 **Note only** | A note exists and is good, but it was written **before this pipeline existed** — from a secondary source or a read with no capture on file. The drive's own PDFs have never been opened |
| 🔴 **Pending** | No note at all |
| ⚫ **Out of scope** | On the drive, not a miniatures wargame or not relevant |

---
## 🟢 Captured — read through the pipeline

| Game | Drive folder | PDFs in folder | Read | Depth | Note |
|---|---|:--:|:--:|---|---|
| **Fallout: Wasteland Warfare** | `Fallout` | 136 | 5 | primary (4 of 5 official-confirmed) | [[Fallout Wasteland Warfare]] |
...
---
## 🟡 Note only — the drive's PDFs have never been opened

**This is where the real backlog is.** Each of these has a note we trust, but written from a *different* source than the files sitting on the drive. Upgrading any of them is cheaper than a fresh capture, because the note's structure already exists.
...
---
## 🔴 Pending — no note exists

| Game | Folder | PDFs | What it is | Worth doing? |
|---|---|:--:|---|---|
...
| Folder | PDFs | Why |
|---|:--:|---|
| `Dungeoin Crawl Classic` | **962** | Fantasy RPG. **61% of the entire library** and irrelevant to Settlements — excluded from all scans |
| `BB Rules`, `HH`, `Tokens` | 0 | Empty of PDFs |
| `Maggotkin 1k (PTG) (HTML).pdf` | 1 | An AoS army list, loose in root |

---
## 📚 Notes with no PDF on the drive

These came from `docs/POINTS-RESEARCH.md` (a costing-focused secondary sweep) or the open web. They are **good notes on a narrow axis** — most were read only for how they derive points costs.

| Note | Source | If we ever want more |
|---|---|---|
| [[BattleTech]] | published BV2 + MegaMek source | Complete for our purposes |
| [[One Page Rules]] | official calculator, verified 4/4 | Complete |
| [[Song of Blades and Heroes]] | official chart, formula verified 34/34 | Complete |
| [[Malifaux]] | official M3E Rules Manual | Complete |
| [[Gaslands]] | official QRS v3 | Complete |
| [[Bolt Action]] | published cost tables | Complete |
| [[The Rampant line]] | 21 published builds | Complete |
| [[Warmachine and Hordes]] | designer statements | Complete |
| [[Games Workshop published formulas]] | archive scans | One modifier table unreadable — needs a better scan |
| [[Infinity]] | official wiki (N5.2) | ⭐ **A real N5 rulebook PDF would let us verify the tables** |
| [[Horizon Wars]] | ⚠️ second-hand, profile structure only | ⭐ Thinnest note in the vault |
